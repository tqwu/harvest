...
export class UserResolver {
  ...
  async countUser(): Promise<UserCount> {
  ...
  async createUser(@Arg("input") input: UserCreate): Promise<PublicUser> {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  @Mutation((returns) => PublicUser)
  async deleteUser(@Arg("input") input: UserDelete): Promise<PublicUser> {
